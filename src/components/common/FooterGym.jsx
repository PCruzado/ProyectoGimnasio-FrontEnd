      ...
      <Container>
        <Row className="gy-4 text-center text-md-start">
          <Col md={4}>
            ...
            {/* Cambiamos text-muted por text-secondary para mejor contraste */}
          ...
          <Col md={4}>
            ...
            <ul className="list-unstyled small text-secondary">
              <li className="mb-2">
                <i className="bi bi-geo-alt text-primary me-2"></i> Gral. Paz 576, Tucumán
              </li>
              <li className="mb-2">
                <i className="bi bi-telephone text-primary me-2"></i> +54 381 222-2222
              </li>
              <li className="mb-2">
                <i className="bi bi-envelope text-primary me-2"></i> info@rollinggym.com
              </li>
            </ul>
          </Col>
          <Col md={4} className="text-center">
            ...
            <div className="d-flex justify-content-center gap-3 fs-4">
              ...
              <a href="#" className="text-primary"><i className="bi bi-twitter-x"></i></a>
            </div>
          </Col>
        </Row>
